...
const IColor = ["black", "gray", "red", "yellow", "green", "blue", "indigo", "purple", "pink"];
const SButton = ({
  color = "blue",
  icon = "",
  size = "medium",
  ...
  return /* @__PURE__ */ jsxs("button", {
    className: `
      ...
      mx-1
    `,
    children: [children ? children : "", icon !== "" ? /* @__PURE__ */ jsx("i", {
      className: `i-ic-baseline-${icon} p-3`
    }) : ""]
  });
};
SButton.prototype = {
  color: propTypes.exports.oneOf(IColor),
  size: propTypes.exports.oneOf(ISize)
};
export {
  SButton
};
